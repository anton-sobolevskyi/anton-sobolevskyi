# Hi there, I'm Anton Sobolevskyi 👋
### Senior Front-End Engineer | React & Angular Specialist

I am a passionate Front-End Developer with over 5 years of commercial experience in building robust, scalable, and high-performing web applications. My expertise spans both major ecosystems — **React** and **Angular**, allowing me to build everything from dynamic, rapid-growth MVPs to complex, enterprise-level SaaS platforms.
...
| **Tools & Testing**          | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![Webpack](https://img.shields.io/badge/Webpack-8DD6F9?style=flat-square&logo=webpack&logoColor=black) `Playwright` `Jasmine` `Karma` `RESTful APIs` |

---

### 💡 What I Bring to the Table

- **Single Page Applications (SPAs):** Crafting smooth, fast, and highly interactive user interfaces from scratch.
- **State Management Expert:** Designing clean data flows using Redux Toolkit (React) and RxJS reactive streams (Angular).
